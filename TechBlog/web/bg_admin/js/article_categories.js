...
function load_categories() {
	...
	$.post(url, data, function (data) {
		...
		for (var i = 0; i < ret_data.length; i++) {
			...
			var obj = ret_data[i];
			var category = "<tr><td>" + obj.categoryName + "</td><td>" + obj.createTime.substr(0, 19) + "</td><td>" + obj.articleCount + "</td><td>" + settop + "</td><td><input type='image' src='../images/icn_edit.png' title='Edit Category' onclick='edit(" + JSON.stringify(obj) + ")'/><input type='image' src='../images/icn_trash.png' title='Delete Category' onclick='delete_category(" + JSON.stringify(obj) + ")'/></td></tr>";
