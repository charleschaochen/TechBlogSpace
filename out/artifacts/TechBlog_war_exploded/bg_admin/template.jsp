...
<html lang="en">
	...
	<body>
		...
		<!-- beginning of secondary bar -->
		<section id="secondary_bar">
		<div class="user">
			<p>
				Charles (
				<a href="#">3 new messages</a>)
			</p>
			<a class="logout_user" href="javascript:logout();" title="Logout">Logout</a>
		</div>
		<div class="breadcrumbs_container">
			<article class="breadcrumbs">
			<a href="index.html">Charles Tech Blog Admin</a>
		...
		<%@include file="common/common_sidebar.html"%>

		<section id="main" class="column">

		<h4 class="alert_info" id="welcome">
			Welcome to the free MediaLoot admin panel template, this could be an
			informative message.
		</h4>
		...
		<div class="module_content">
			...
			<img
				src="http://chart.apis.google.com/chart?cht=lc&chxr=0,0,3000&chxt=y&chs=520x140&chco=76A4FB,80C65A&chd=s:Tdjpsvyvttmiihgmnrst,OTbdcfhhggcTUTTUadfk&chls=2|2&chma=40,20,20,30"
		...
		<div class="module_content">
			...
			<p>
				...
				<a href="#">link text</a> gravida at eget metus. Donec ullamcorper
				nulla non metus auctor fringilla. Cras mattis consectetur purus sit
				amet fermentum. Aenean eu leo quam. Pellentesque ornare sem lacinia
